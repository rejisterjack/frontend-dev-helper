...
export const allTools: ToolPageData[] = [
  {
    slug: 'css-debugger',
    name: 'CSS Debugger',
    tagline: 'Instantly visualize, inspect, and fix CSS issues directly in the browser.',
    description:
    ...
    metaTitle: 'CSS Debugger Chrome Extension — Visual CSS Debugging Tool | FrontendDevHelper',
    metaDescription:
    ...
    faq: [
      ...
      {
        question: 'Does it work with CSS frameworks like Tailwind, Bootstrap, or Material UI?',
        answer:
    ...
    relatedTools: ['accessibility-checker', 'dom-inspector', 'color-picker', 'performance-profiler'],
  },
  {
    slug: 'accessibility-checker',
    name: 'Accessibility Checker',
    tagline: 'Audit WCAG compliance and find accessibility issues in seconds, not hours.',
    description:
    ...
    metaTitle: 'Accessibility Checker Chrome Extension — WCAG Audit Tool | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['css-debugger', 'dom-inspector', 'color-picker', 'performance-profiler'],
  },
  {
    slug: 'performance-profiler',
    name: 'Performance Profiler',
    tagline: 'Measure page load performance, rendering bottlenecks, and layout shifts visually.',
    description:
    ...
    metaTitle: 'Performance Profiler Chrome Extension — Core Web Vitals Tool | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['css-debugger', 'dom-inspector', 'accessibility-checker', 'color-picker'],
  },
  {
    slug: 'color-picker',
    name: 'Color Picker',
    tagline: 'Pick, convert, and manage colors from any webpage with one click.',
    description:
    ...
    metaTitle: 'Color Picker Chrome Extension — Eyedropper & Palette Tool | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['css-debugger', 'accessibility-checker', 'dom-inspector', 'performance-profiler'],
  },
  {
    slug: 'dom-inspector',
    name: 'DOM Inspector',
    tagline: 'Navigate, search, and visualize the DOM tree with powerful on-page overlays.',
    description:
    ...
    metaTitle: 'DOM Inspector Chrome Extension — Visual DOM Explorer | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['css-debugger', 'accessibility-checker', 'performance-profiler', 'color-picker'],
  },
  {
    slug: 'z-index-visualizer',
    name: 'Z-Index Visualizer',
    tagline: 'See stacking order in 3D, debug z-index conflicts, and fix overlapping elements visually.',
    description:
    ...
    metaTitle: 'Z-Index Visualizer Chrome Extension — 3D Stacking Context Tool | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['css-debugger', 'dom-inspector', 'element-inspector', 'css-inspector'],
  },
  {
    slug: 'flex-grid-visualizer',
    name: 'Flex/Grid Visualizer',
    tagline: 'Interactive visualization of Flexbox and CSS Grid layouts with alignment and spacing debugging.',
    description:
    ...
    metaTitle: 'Flexbox & Grid Visualizer Chrome Extension — CSS Layout Debugging | FrontendDevHelper',
    metaDescription:
    ...
    faq: [
      ...
      {
        question: 'Does it work with CSS frameworks like Tailwind or Bootstrap?',
        answer:
    ...
    relatedTools: ['css-debugger', 'spacing-visualizer', 'responsive-tester', 'css-inspector'],
  },
  {
    slug: 'font-inspector',
    name: 'Font Inspector',
    tagline: 'Analyze typography on any page — detect font stacks, sizes, weights, line heights, and sources.',
    description:
    ...
    metaTitle: 'Font Inspector Chrome Extension — Typography Analysis Tool | FrontendDevHelper',
    metaDescription:
    ...
    faq: [
      ...
      {
        question: 'Does it show the difference between declared and rendered fonts?',
        answer:
    ...
    relatedTools: ['css-debugger', 'css-inspector', 'element-inspector', 'dom-inspector'],
  },
  {
    slug: 'responsive-tester',
    name: 'Breakpoint Overlay',
    tagline: 'View current viewport size, responsive breakpoints, and test layouts at any screen size.',
    description:
    ...
    metaTitle: 'Responsive Breakpoint Tester Chrome Extension — Viewport & Media Query Tool | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['css-debugger', 'flex-grid-visualizer', 'pixel-ruler', 'screenshot-studio'],
  },
  {
    slug: 'element-inspector',
    name: 'Element Inspector',
    tagline: 'Hover tooltip showing element tag, classes, dimensions, and computed styles at a glance.',
    description:
    ...
    metaTitle: 'Element Inspector Chrome Extension — Quick Element Info Tooltip | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['dom-inspector', 'css-debugger', 'css-inspector', 'smart-picker'],
  },
  {
    slug: 'contrast-checker',
    name: 'Contrast Checker',
    tagline: 'WCAG AA/AAA color contrast analysis — detect accessibility issues in text/background pairs.',
    description:
    ...
    metaTitle: 'Contrast Checker Chrome Extension — WCAG Color Accessibility Tool | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['accessibility-checker', 'css-debugger', 'color-picker', 'element-inspector'],
  },
  {
    slug: 'tech-detector',
    name: 'Tech Detector',
    tagline: 'Detect frameworks, libraries, CSS frameworks, and build tools running on any webpage.',
    description:
    ...
    metaTitle: 'Tech Detector Chrome Extension — Identify Frameworks & Libraries | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['dom-inspector', 'component-tree', 'network-analyzer', 'css-debugger'],
  },
  {
    slug: 'accessibility-audit',
    name: 'Accessibility Audit',
    tagline: 'Full WCAG validator, ARIA checker, and comprehensive accessibility auditing in one click.',
    description:
    ...
    metaTitle: 'Accessibility Audit Chrome Extension — Full WCAG Validator | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['accessibility-checker', 'contrast-checker', 'focus-debugger', 'form-debugger'],
  },
  {
    slug: 'network-analyzer',
    name: 'Network Analyzer',
    tagline: 'Monitor network requests, analyze load times, and detect slow resources on any page.',
    description:
    ...
    metaTitle: 'Network Analyzer Chrome Extension — Request Monitor & Load Time Tool | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['performance-profiler', 'css-scanner', 'storage-inspector', 'flame-graph'],
  },
  {
    slug: 'component-tree',
    name: 'Component Tree',
    tagline: 'Visualize React, Vue, Angular, and Svelte component hierarchies in an interactive tree view.',
    description:
    ...
    metaTitle: 'Component Tree Chrome Extension — React, Vue, Angular Component Viewer | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['dom-inspector', 'tech-detector', 'element-inspector', 'performance-profiler'],
  },
  {
    slug: 'flame-graph',
    name: 'Performance Flame Graph',
    tagline: 'JavaScript execution profiling with flame graphs to identify performance bottlenecks.',
    description:
    ...
    metaTitle: 'Performance Flame Graph Chrome Extension — JS Profiling Tool | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['performance-profiler', 'network-analyzer', 'component-tree', 'css-scanner'],
  },
  {
    slug: 'storage-inspector',
    name: 'Storage Inspector',
    tagline: 'Debug LocalStorage, SessionStorage, IndexedDB, Cookies, and Cache API in one panel.',
    description:
    ...
    metaTitle: 'Storage Inspector Chrome Extension — LocalStorage, IndexedDB, Cookie Tool | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['network-analyzer', 'dom-inspector', 'css-debugger', 'element-inspector'],
  },
  {
    slug: 'focus-debugger',
    name: 'Focus Debugger',
    tagline: 'Visualize tab focus order, detect focus traps, and debug keyboard navigation issues.',
    description:
    ...
    metaTitle: 'Focus Debugger Chrome Extension — Keyboard Navigation & Tab Order Tool | FrontendDevHelper',
    metaDescription:
    ...
    faq: [
      {
        question: 'Does it work with dynamic content like modals and dropdowns?',
        answer:
    ...
    relatedTools: ['accessibility-checker', 'accessibility-audit', 'element-inspector', 'form-debugger'],
  },
  {
    slug: 'form-debugger',
    name: 'Form Debugger',
    tagline: 'Debug form validation, detect missing labels, and fix broken autofill patterns.',
    description:
    ...
    metaTitle: 'Form Debugger Chrome Extension — Form Validation & Accessibility Tool | FrontendDevHelper',
    metaDescription:
    ...
    faq: [
      {
        question: 'Does it work with React Hook Form, Formik, or other form libraries?',
        answer:
    ...
    relatedTools: ['accessibility-checker', 'accessibility-audit', 'focus-debugger', 'element-inspector'],
  },
  {
    slug: 'visual-regression',
    name: 'Visual Regression Testing',
    tagline: 'Screenshot comparison to detect visual changes between page states and deployments.',
    description:
    ...
    metaTitle: 'Visual Regression Testing Chrome Extension — Screenshot Diff Tool | FrontendDevHelper',
    metaDescription:
    ...
    faq: [
      {
        question: 'How does this differ from automated visual regression tools like Percy or Chromatic?',
        answer:
      ...
      {
        question: 'Does it handle dynamic content like timestamps and random data?',
        answer:
    ...
    relatedTools: ['screenshot-studio', 'css-debugger', 'responsive-tester', 'css-scanner'],
  },
  {
    slug: 'command-palette',
    name: 'Command Palette',
    tagline: 'VS Code-style quick access to all tools with keyboard shortcuts (Ctrl+Shift+P).',
    description:
      'The Command Palette is a productivity tool built into FrontendDevHelper that provides a VS Code-style search interface activated with Ctrl+Shift+P, giving you instant keyboard access to all 39 tools, settings, and actions — keeping your hands on the keyboard and your workflow uninterrupted.',
    metaTitle: 'Command Palette Chrome Extension — VS Code-Style Quick Access | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['css-debugger', 'dom-inspector', 'element-inspector', 'smart-picker'],
  },
  {
    slug: 'ai-suggestions',
    name: 'AI Suggestions',
    tagline: 'Smart detection of 50+ patterns across accessibility, performance, SEO, and security with auto-fixes.',
    description:
    ...
    metaTitle: 'AI Suggestions Chrome Extension — Smart Code Fix Tool | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['accessibility-checker', 'performance-profiler', 'css-scanner', 'css-debugger'],
  },
  {
    slug: 'spacing-visualizer',
    name: 'Spacing Visualizer',
    tagline: 'Visualize margin and padding overlays for any element on the page.',
    description:
    ...
    metaTitle: 'Spacing Visualizer Chrome Extension — Margin & Padding Overlay Tool | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['css-debugger', 'flex-grid-visualizer', 'pixel-ruler', 'css-inspector'],
  },
  {
    slug: 'css-inspector',
    name: 'CSS Inspector',
    tagline: 'All computed CSS properties organized by category — layout, typography, colors, and effects.',
    description:
    ...
    metaTitle: 'CSS Inspector Chrome Extension — Computed Styles by Category | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['css-debugger', 'css-scanner', 'element-inspector', 'spacing-visualizer'],
  },
  {
    slug: 'pixel-ruler',
    name: 'Pixel Ruler',
    ...
    metaTitle: 'Pixel Ruler Chrome Extension — Distance Measurement Tool | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['css-debugger', 'spacing-visualizer', 'screenshot-studio', 'responsive-tester'],
  },
  {
    slug: 'screenshot-studio',
    name: 'Screenshot Studio',
    tagline: 'Full-page, viewport, or element screenshots with annotation tools.',
    description:
    ...
    metaTitle: 'Screenshot Studio Chrome Extension — Annotate & Capture Tool | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['visual-regression', 'responsive-tester', 'pixel-ruler', 'css-debugger'],
  },
  {
    slug: 'css-scanner',
    name: 'CSS Scanner',
    tagline: 'Detect CSS anti-patterns, unused styles, specificity issues, and performance problems.',
    description:
    ...
    metaTitle: 'CSS Scanner Chrome Extension — Unused CSS & Specificity Tool | FrontendDevHelper',
    metaDescription:
    ...
    faq: [
      {
        question: 'Does unused CSS detection work for single-page applications?',
        answer:
    ...
    relatedTools: ['css-debugger', 'css-inspector', 'performance-profiler', 'network-analyzer'],
  },
  {
    slug: 'smart-picker',
    ...
    metaTitle: 'Smart Element Picker Chrome Extension — Advanced Element Selection | FrontendDevHelper',
    metaDescription:
    ...
    relatedTools: ['element-inspector', 'dom-inspector', 'css-debugger', 'component-tree'],
  },
  {
    slug: 'animation-inspector',
    name: 'Animation Inspector',
    tagline: 'Inspect CSS animations and transitions with playback speed control.',
    description:
    ...
    metaTitle: 'Animation Inspector Chrome Extension — CSS Animation Debugging Tool | FrontendDevHelper',
    metaDescription:
    ...
    faq: [
      ...
      {
        question: 'Does it work with animation libraries like GSAP or Framer Motion?',
        answer:
    ...
    relatedTools: ['css-debugger', 'css-inspector', 'performance-profiler', 'flame-graph'],
  },
];
