/**
 * React Internal Types — minimal type definitions for React internals
 * used by the profiler bridge.
 *
 * Ported from react-perf-profiler/apps/ext/entrypoints/bridge.content/reactInternals.ts.
 */
...
declare global {
  interface Window {
    ...
    __FDH_PROFILER_ACTIVE__?: boolean;
    __FDH_PROFILER_CLEANUP__?: () => void;
    __FDH_PROFILER_DETECT_REACT__?: () => boolean;
