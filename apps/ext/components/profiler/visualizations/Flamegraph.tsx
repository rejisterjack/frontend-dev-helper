/**
 * Flamegraph — D3 icicle chart of React fiber render durations.
 *
 * Ported from react-perf-profiler/apps/ext/src/panel/components/visualizations/Flamegraph.tsx.
 */

import React, { useRef, useEffect, useState, useCallback } from "react";
import * as d3 from "d3";
import type { FiberData } from "@repo/profiler-contract";
...
const Flamegraph: React.FC<FlamegraphProps> = ({
  ...
  useEffect(() => {
    ...
    const descendants: PartitionNode[] =
      zoomClone.descendants() as PartitionNode[];
