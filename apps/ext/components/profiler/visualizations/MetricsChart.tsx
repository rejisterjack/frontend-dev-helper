/**
 * MetricsChart — horizontal bar chart for arbitrary labeled metrics.
 *
 * Ported from react-perf-profiler/apps/ext/src/panel/components/visualizations/MetricsChart.tsx.
 */
...
const MetricsChart: React.FC<MetricsChartProps> = ({
  ...
  useEffect(() => {
    ...
    const barGap = 6;
    const totalHeight =
      sorted.length * (barHeight + barGap) + MARGIN.top + MARGIN.bottom;
    ...
    const groups = g
      ...
      .attr(
        "transform",
        (_d, i) => `translate(0, ${i * (barHeight + barGap)})`,
      );
