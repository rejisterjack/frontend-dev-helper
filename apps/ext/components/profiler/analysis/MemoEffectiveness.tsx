 ...
 *
 * Ported from react-perf-profiler/apps/ext/src/panel/components/analysis/MemoEffectiveness.tsx.
 */

import type {
  MemoReport as MemoReportType,
  Severity,
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-muted-foreground">
        ...
        <p className="text-xs mt-1">
          Components wrapped with React.memo() or PureComponent will appear
          here.
        </p>
      </div>
    );
              ...
              <div className="mt-1">
                <div className="flex items-center justify-between text-xs mb-1">
                  <span className="text-muted-foreground">
                    Hit Rate: {report.currentHitRate}% (
                    {getHitRateLabel(report.currentHitRate)})
                  </span>
                  <span className="text-muted-foreground">
