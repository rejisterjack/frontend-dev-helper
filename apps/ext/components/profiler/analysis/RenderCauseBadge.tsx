/**
 * RenderCauseBadge — small badge indicating what caused a render.
 *
 * Ported from react-perf-profiler/apps/ext/src/panel/components/analysis/RenderCauseBadge.tsx.
 */

import type { Severity } from "@repo/profiler-contract";
...
const CAUSE_CONFIG: Record<string, { label: string; className: string }> = {
  "prop-change": {
    label: "Prop Change",
    className:
  ...
  "inline-object": {
    label: "Inline Object",
    className:
      "bg-pink-500/15 text-pink-700 border-pink-500/25 dark:text-pink-400",
  },
  "inline-array": {
    label: "Inline Array",
    className:
