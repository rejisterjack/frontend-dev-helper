 ...
 *
 * Ported from react-perf-profiler/apps/ext/src/panel/components/analysis/WastedRenderReport.tsx.
 */

import type {
  Severity,
  WastedRenderReport as WastedRenderReportType,
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-muted-foreground">
        ...
        <p className="text-xs mt-1">
          Your components are rendering efficiently.
        </p>
      </div>
    );
  }
    ...
    <div className="flex flex-col gap-3 p-4">
      ...
      <div className="flex flex-col gap-2">
        {reports.map((report) => {
          ...
          const actionStyle =
            ACTION_STYLES[report.recommendedAction] ?? ACTION_STYLES.none;
              ...
              <CardHeader className="pb-0">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    <Badge
                      variant="outline"
                      className={cn("text-[10px]", severityStyle.badge)}
                    >
                      <span
                        className={cn(
                    ...
                    <Badge
                      variant="outline"
                      className={cn("text-[10px]", actionStyle)}
                    >
