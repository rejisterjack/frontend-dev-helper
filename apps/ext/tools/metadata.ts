...
export const toolMetadata: Record<string, ToolMetadata> = {
  ...
  'react-render-tracker': {
    ...
    category: 'performance',
    icon: 'Activity',
    loader: () => import('./performance/react-render-tracker'),
  },
  'network-replay': {
    id: 'network-replay',
    name: 'Network Replay',
  ...
  'accessibility-audit': {
    ...
    description: 'Run comprehensive accessibility audit against WCAG guidelines',
  ...
  'component-analyzer': {
    ...
    loader: () => import('./ai/component-analyzer'),
  },
  'ai-auto-fix': {
    id: 'ai-auto-fix',
    name: 'AI Auto-Fix',
  ...
  'full-audit': {
    id: 'full-audit',
    name: 'Full Audit',
    description: 'One-click comprehensive audit across accessibility, performance, SEO, and best practices',
    category: 'utility',
...
export const metadataByCategory: Record<ToolCategory, ToolMetadata[]> = {
  inspection: Object.values(toolMetadata).filter((t) => t.category === 'inspection'),
  css: Object.values(toolMetadata).filter((t) => t.category === 'css'),
  performance: Object.values(toolMetadata).filter((t) => t.category === 'performance'),
  accessibility: Object.values(toolMetadata).filter((t) => t.category === 'accessibility'),
